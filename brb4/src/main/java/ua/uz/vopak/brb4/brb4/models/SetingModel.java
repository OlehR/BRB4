...
public class SetingModel {
    ...
    public void OnClickGen(){
        ...
        apiURLadd.set(Company==eCompany.Sim23 ? "http://93.183.216.37/TK/hs/TSD/;http://37.53.84.148/TK/hs/TSD/":"http://api.spar.uz.ua/print/;http://znp.vopak.local:8088/Print");
